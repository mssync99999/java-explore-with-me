...
public interface RequestRepository extends JpaRepository<Request, Long> {
    ...
    //...
    //запросный метод + ассоциация Booker.Id
    //List<Event> findAllByIdIn(List<Long> events);
    //Page<User> findAllByIdIn(List<Long> ids, PageRequest pageRequest);

    Optional<Request> findByRequesterIdAndEventId(Long userId, Long eventId); //или findByUser_IdAndEvent_Id
    ...
    //-List<Request> findAllByIdAndStatusIs(List<Long> ids, StatusRequest status);
